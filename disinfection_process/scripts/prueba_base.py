#! /usr/bin/env python
""" ESTE CODIGO ERA PARA FUNCIONAR CON LA SIMULACION QUE HICIMOS EN SU MOMENTO """
import rospy
import numpy as np
import tf
import tf2_ros
...
class CircularMove(): # TODO: CAMBIAR NOMBRE O ALGO
    ...
    def __init__(self, _coord, _gap, _radius):
        ...
        self.move_base_client = actionlib.SimpleActionClient('/rbkairos/move_base', MoveBaseAction)
    ...
    def get_robot_position(self):   # FIXME:  tal vez tengamos que cambiar "position" por "location" o algo asi
        ...
        sub_pose = rospy.Subscriber('/rbkairos/amcl_pose', PoseWithCovarianceStamped, self.pose_callback)
    ...
    def start_process(self):
        ...
        for app_point in self.sequence:
            ...
            self.goal.target_pose.header.frame_id = 'rbkairos_odom'
    ...
    def navigate_to_pose(self, goal_pose, app_point):
        ...
        self.pub_base_goal.publish(self.goal.target_pose)
...
if __name__ == "__main__":
    ...
    move_obj = CircularMove([11, 0, 1.0], 0.85, 0.2)
    #move_obj.move()
