...
class Movimiento ():
    def __init__(self, group = "manipulator", frame = "robot_map", endeff = "rbkairos_ur10_tool0"):
        ...
        self.group.set_end_effector_link("robot_ur10_ee_link")  # FIXME: cuando se ponga el spray, el end_effector sera: robot_spray_tool_end_link 
    ...
    def move_case(self, case_code): # obtencion de puntos y orientaciones que rodean el objeto, segun el caso indicado por 'case_code'
        ...
        pub_msg.pose = waypoints[-1]    # el ultimo elemento
        self.publish_(self.pub_tool_goal, pub_msg)
