...
""" ESTE ES EL QUE TENEMOS QUE EJECUTAR PARA PROBAR LA NAVEGACION HACIA UN PUNTO Y LUEGO DESPUES HACIA LOS 4"""
import rospy
import numpy as np
import tf
import tf2_ros
...
if __name__ == "__main__":
    ...
    move_obj = CircularMove([0, 0, 1.0], 0.45, 0.2)
    
    # para probar la navegacion a un unico punto
    move_obj.simple_go_to_point([0.5,0,1], [0,0,0])
