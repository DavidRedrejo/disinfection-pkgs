...
""" ESTE ES EL QUE TENEMOS QUE EJECUTAR PARA HACER PRUEBA DE MOVIMIENTO
...
class Movimiento ():
    def __init__(self, group = "arm", frame = "robot_base_footprint", endeff = "robot_spray_tool_end_link"):
        ...
        self.group.set_end_effector_link(endeff)  # FIXME: cuando se ponga el spray, el end_effector sera: robot_spray_tool_end_link 
    ...
    def set_joint_pose_case(self, case):
        ...
        if case.upper() == "INIT":
            ...
            joint_values = [0.0, -1.57, -2.85, 1.32, 1.57, 0.0]     # es mas seguro esto que ponerlo todo a 0
    ...
    def move_case(self, case_code): # obtencion de puntos y orientaciones que rodean el objeto, segun el caso indicado por 'case_code'
        ...
        pub_msg = PoseStamped()
        pub_msg.header.frame_id="robot_base_footprint"
